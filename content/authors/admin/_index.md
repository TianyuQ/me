...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:tianyuqiu@utexas.edu'
  # - icon: twitter
  #   icon_pack: fab
  ...
  - icon: google-scholar # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: ai
    link: https://scholar.google.com/citations?user=_drTP1MAAAAJ&hl=en&oi=sra
  - icon: github
    icon_pack: fab
    link: https://github.com/TianyuQ
  - icon: linkedin
    icon_pack: fab
  ...
  - icon: cv
    icon_pack: ai
    link: uploads/Tianyu Qiu Resume.pdf
